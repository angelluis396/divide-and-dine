  ...
  return (
  	...
  	<div className='mt-2 grid grid-cols-3 gap-3'>
			{tips.map((tip, index) => (
					...
					{tip.isCustom ? (
						<>
							{customSelected ? (
								...
								<button
                  type="button"
                  className="w-full rounded-md bg-[#f4efe4] px-3.5 py-2.5 font-medium text-cyan-700 shadow-sm hover:bg-gray-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-600"
              ...
              className={`${
              index === activeTip
              	? 'bg-[#8ec2ca] text-[#f4efe4] hover:bg-[#c3dfe3]'
                : 'bg-[#68AEB8] text-[#f4efe4] hover:bg-[#b3d6db]'
